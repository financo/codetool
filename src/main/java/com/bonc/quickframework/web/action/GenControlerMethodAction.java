...
import com.bonc.quickframework.web.action.original.AbstractGenControlerMethodAction;
...
@Controller(value = "genControlerMethodAction")
@Scope(value = "prototype")
public class GenControlerMethodAction extends AbstractGenControlerMethodAction {
