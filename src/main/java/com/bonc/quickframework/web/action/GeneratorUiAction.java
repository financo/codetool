...
import com.bonc.quickframework.web.action.original.AbstractGeneratorUiAction;
...
@Controller(value = "generatorUiAction")
@Scope(value = "prototype")
public class GeneratorUiAction extends AbstractGeneratorUiAction {
