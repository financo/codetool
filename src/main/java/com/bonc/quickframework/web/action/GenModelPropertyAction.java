...
import com.bonc.quickframework.web.action.original.AbstractGenModelPropertyAction;
...
@Controller(value = "genModelPropertyAction")
@Scope(value = "prototype")
public class GenModelPropertyAction extends AbstractGenModelPropertyAction {
