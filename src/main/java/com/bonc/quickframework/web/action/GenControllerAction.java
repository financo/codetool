...
import com.bonc.quickframework.web.action.original.AbstractGenControllerAction;
...
@Controller(value = "genControllerAction")
@Scope(value = "prototype")
public class GenControllerAction extends AbstractGenControllerAction {
