...
import com.bonc.quickframework.bean.GenUiBean;
...
public class AbstractGenUiAction extends BaseAction {
	
	GenUiBean bean=new GenUiBean();
	
	@Resource(name = "genUiService")
	protected IGenUiService genUiService;


	public GenUiBean getBean() {
		return bean;
	}

	public void setBean(GenUiBean bean) {
		this.bean = bean;
	}
	
	public String list() {
		List dataList = this.genUiService.findList(this.getBean());
	...
	public String addDo() {
		this.genUiService.saveOrUpdate(this.getBean().getGenUi());
		return SUCCESS;
	}
	public String edit() {
		GenUi genUi=this.genUiService.findById(this.getBean().getGenUi().getId());
		this.getBean().setGenUi(genUi);
		return "edit";
	}
	...
	public String delete() {
		this.genUiService.delete(this.getBean().getGenUi().getId());
		return SUCCESS;
	}
	...
	public void asyncDeleteAll() {
		try {
			...
			if(idString == null || "".endsWith(idString.trim())){
				...
				this.genUiService.deleteByCollection(this.genUiService.findList(ids));
			}
