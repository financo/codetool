...
import com.bonc.quickframework.web.action.original.AbstractGeneratorWebserverAction;
...
@Controller(value = "generatorWebserverAction")
@Scope(value = "prototype")
public class GeneratorWebserverAction extends AbstractGeneratorWebserverAction {
