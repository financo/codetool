					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-user">
								<li><a href="SRFieldConfig!add.action?bean.generatorField.entityId=${bean.generatorField.entityId }">新增</a></li>
							</ul>
					...
					<div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<div class="row">
								...
								<div class="col-sm-12">
									<form role="form" class="form-inline form_search" method="post" action="SRFieldConfig!list.action">
										<a class="btn btn-white btn_delete_selected" href="javascript:;" url="SRFieldConfig!asyncDeleteAll.action" style="float: right;">删除</a>
										<a class="btn btn-white" href="SRFieldConfig!add.action?bean.generatorField.entityId=${bean.generatorField.entityId }" style="float: right;margin-right:10px;">新增</a>
											<!-- search -->
		...
		<s:else>
			<s:iterator value="bean.objectList" var="item" status="s">
				<tr>
					...
					<td>
						<a href="SRFieldConfig!edit.action?bean.generatorField.id=${item.id}&bean.generatorField.entityId=${item.entityId }">修改</a>&nbsp;
						<a href="javascript:;" url="SRFieldConfig!asyncDeleteAll.action?bean.idList=<s:property value="#item.id"/>" class="btn_delete_item">删除</a>&nbsp;
					</td>
				</tr>
			</s:iterator>
		</s:else>
...
<u:pageLink  linkId="123" align="right" action="SRFieldConfig!list.action" 
