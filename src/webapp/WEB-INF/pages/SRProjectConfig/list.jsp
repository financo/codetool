					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-user">
								<li><a href="SRProjectConfig!add.action">新增</a></li>
							</ul>
					...
					<div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<div class="row">
								...
								<div class="col-sm-12">
									<form role="form" class="form-inline" method="post" action="SRProjectConfig!list.action">
										<a class="btn btn-white" href="SRProjectConfig!add.action" style="float: right;">新增</a>
											<!-- search -->
		...
		<s:else>
			<s:iterator value="bean.objectList" var="item" status="s">
				<tr>
					...
					<td class="td-btns">
						<a href="SRProjectConfig!edit.action?bean.generatorProject.id=<s:property value="#item.id"/>">修改</a>&nbsp;
						<a href="SRProjectConfig!delete.action?bean.generatorProject.id=<s:property value="#item.id"/>">删除</a>&nbsp;
						
						<a class="btn_generate" href="javascript:;" url="SRProjectConfig!generate.action?bean.generatorProject.id=<s:property value="#item.id"/>"> 生成代码</a>&nbsp;
						<a href="SREntityConfig!list.action?bean.generatorEntity.projectId=${item.id }"> 查看实体</a>&nbsp;
					</td>
				</tr>
			</s:iterator>
		</s:else>
...
<u:pageLink  linkId="123" align="right" action="SRProjectConfig!list.action" 
