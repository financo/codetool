					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-user">
								<li><a href="generatorDbserver!add.action">新增</a></li>
							</ul>
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<form role="form" class="form-inline" method="post" action="generatorDbserver!list.action">
										<a class="btn btn-white" href="generatorDbserver!add.action" style="float: right;">新增</a>
											<!-- search -->
		...
		<s:else>
			<s:iterator value="bean.objectList" var="item" status="s">
				<tr>
					...
					<td>
						<a href="generatorDbserver!edit.action?bean.generatorDbserver.id=<s:property value="#item.id"/>">修改</a>&nbsp;
						<a href="generatorDbserver!delete.action?bean.generatorDbserver.id=<s:property value="#item.id"/>">删除</a>&nbsp;
					</td>
				</tr>
			</s:iterator>
		</s:else>
...
<u:pageLink  linkId="123" align="right" action="generatorDbserver!list.action" 
