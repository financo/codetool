					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-user">
								<li><a href="SREntityConfig!add.action?bean.generatorEntity.projectId=${bean.generatorEntity.projectId }">新增</a></li>
							</ul>
					...
					<div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<div class="row">
								...
								<div class="col-sm-12">
									<form role="form" class="form-inline" method="post" action="SREntityConfig!list.action">
										<a class="btn btn-white" href="SREntityConfig!add.action?bean.generatorEntity.projectId=${bean.generatorEntity.projectId }" style="float: right;">新增</a>
											<!-- search -->
		...
		<s:else>
			<s:iterator value="bean.objectList" var="item" status="s">
				<tr>
					...
					<td>
						<a href="SREntityConfig!edit.action?bean.generatorEntity.id=<s:property value="#item.id"/>&bean.generatorEntity.projectId=${item.projectId }">修改</a>&nbsp;
						<a href="SREntityConfig!delete.action?bean.generatorEntity.id=<s:property value="#item.id"/>">删除</a>&nbsp;
						
						<a href="SRFieldConfig!list.action?bean.generatorField.entityId=${item.id }"> 查看字段</a>&nbsp;
					</td>
				</tr>
			</s:iterator>
		</s:else>
...
<u:pageLink  linkId="123" align="right" action="SREntityConfig!list.action" 
