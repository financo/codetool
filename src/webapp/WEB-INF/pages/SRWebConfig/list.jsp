					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-user">
								<li><a href="SRWebConfig!add.action">新增</a></li>
							</ul>
					...
					<div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<div class="row">
								...
								<div class="col-sm-12">
									<form role="form" class="form-inline" method="post" action="SRWebConfig!list.action">
										<a class="btn btn-white" href="SRWebConfig!add.action" style="float: right;">新增</a>
											<!-- search -->
		...
		<s:else>
			<s:iterator value="bean.objectList" var="item" status="s">
				<tr>
					...
					<td>
						<a href="SRWebConfig!edit.action?bean.generatorWebserver.id=<s:property value="#item.id"/>">修改</a>&nbsp;
						<a href="SRWebConfig!delete.action?bean.generatorWebserver.id=<s:property value="#item.id"/>">删除</a>&nbsp;
					</td>
				</tr>
			</s:iterator>
		</s:else>
...
<u:pageLink  linkId="123" align="right" action="SRWebConfig!list.action" 
