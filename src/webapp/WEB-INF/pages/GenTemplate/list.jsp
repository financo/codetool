					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-user">
								<li><a href="genTemplate!add.action">新增</a></li>
							</ul>
					...
					<div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<div class="row">
								...
								<div class="col-sm-12">
									<form role="form" class="form-inline form_search" method="post" action="genTemplate!list.action">
											<!-- search -->
										...
										<a class="btn btn-white btn_delete_selected" href="javascript:;" url="genTemplate!asyncDeleteAll.action" style="float: right;">删除</a>
										<a class="btn btn-white" href="genTemplate!add.action" style="float: right;margin-right:10px;">新增</a>
									</form>
								</div>
							</div>
			...
			<s:iterator value="bean.objectList" var="item" status="s">
				<tr>
					...
					<td>
						...
						<td><s:property value="#item.tmpPath"/></td>
					<td>
						<a href="genTemplate!edit.action?bean.genTemplate.id=<s:property value="#item.id"/>">修改</a>&nbsp;
						<a url="genTemplate!asyncDeleteAll.action?bean.idList=<s:property value="#item.id"/>" class="btn_delete_item">删除</a>&nbsp;
					</td>
				</tr>
			</s:iterator>
		</s:else>
...
<u:pageLink  linkId="123" align="right" action="genTemplate!list.action" 
